                            ...
                            (vxs (arg-val s2)
                                (local ((define new-loc (next-location)))
                                    (interp-cfwaes
                                        ...
                                        (aSub (closureV-param fun-val) (numV new-loc) (closureV-env fun-val))
...
;(eval-cfwaes `{fun {x} x})
(eval-cfwaes `{with {x 5} {with {y 10} {with {f {fun {x} {assign y x}}} {with {g {fun {y} {+ y 5}}} {+ {f x} {g y}}}}}})
;(eval-cfwaes `{assign x 5})
;(eval-cfwaes `{seqn {if0 0 {assign x 5} {assign x 6}} {+ x 5}})